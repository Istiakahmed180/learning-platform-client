  ...
  return (
    <div className="grid grid-cols-2 mt-20 ">
      <div className="mx-auto">
        <h2 className="font-semibold text-3xl leading-snug mb-6">
        ...
        <form className="mt-10">
          ...
          <div class="relative w-3/4">
            ...
            <button
              type="submit"
              class="text-white absolute right-2.5 bottom-1 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-3 py-1 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
            >
              Search
            </button>
          </div>
