...
const Footer = () => {
  return (
    <div className="relative mt-16 bg-deep-purple-accent-400 ">
      <div className="px-4 pt-12 mx-auto sm:max-w-xl md:max-w-full lg:w-full md:px-24 lg:px-8  shadow-2xl rounded-t-xl shadow-[#18C1A2]">
        ...
        <div className="flex flex-col justify-between pt-5 pb-10 border-t border-deep-purple-accent-200 sm:flex-row">
          ...
          <div className="flex items-center mt-4 space-x-4 sm:mt-0 mx-auto lg:mx-0">
            <Link
              to="/"
              className="transition-colors duration-300 text-deep-purple-100 dark:hover:text-[#18C2A3] text-[#18C2A3]"
            >
